...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__editprofile__ = __webpack_require__(567);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ack_angular_webcam__ = __webpack_require__(570);
...
var EditprofilePageModule = /** @class */ (function () {
    ...
    EditprofilePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__editprofile__["a" /* EditprofilePage */]),
...
var videoHelp_1 = __webpack_require__(563);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash__ = __webpack_require__(568);
...
var EditprofilePage = /** @class */ (function () {
    function EditprofilePage(navCtrl, alertCtrl, _DomSanitizer, platform, actionSheetCtrl, formBuilder, navParams, viewCtrl, firebaseService) {
        ...
        this.emailForm = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["c" /* FormGroup */]({
            username: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormControl */](),
            status: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormControl */](),
    ...
    EditprofilePage.prototype.ionViewDidLoad = function () {
        ...
        this.emailForm = this.formBuilder.group({
            ...
            email: [this.user.email, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].pattern(this.emailValidate)])
            ]
        });
    };
    ...
    EditprofilePage.prototype.closePost = function () {
        this.viewCtrl.dismiss();
    };
    EditprofilePage.prototype.picture = function () {
        var _this = this;
    ...
    EditprofilePage.prototype.camera = function () {
        var _this = this;
        if (this.platform.is('cordova')) {
            this.firebaseService.takePhotograph()
                .then(function (image) {
                _this.user.image = image.toString();
            })
                .catch(function (err) {
                console.log(err);
            });
    ...
    EditprofilePage.prototype.onCamError = function (err) { };
    EditprofilePage.prototype.onCamSuccess = function () { };
    EditprofilePage.prototype.handleFiles = function (event) {
        console.log(event);
        this.files = event.target.files;
        console.log(this.files);
    };
    EditprofilePage.prototype.submit = function (user) {
        var _this = this;
        ...
        if (this.firebaseService.authenticated == false) {
                    ...
                    },
                    {
                        ...
                        handler: function (data) {
                            if (data.email, data.password) {
                                _this.firebaseService.reauthenticateUser(data);
                                //loggedin
                            }
                            else {
                                //failed login
            ...
            if (this.files == undefined) {
                ...
                user.blobFile = "";
                this.firebaseService.updateUser(user).then(function (res) {
                    var oldUser = _this.navParams.get('user');
                    if (user.email != oldUser.email) {
                        setTimeout(function () {
                            _this.firebaseService.verifyEmail(user.email);
                            _this.navCtrl.push('verifyPage', { user: user });
                        }, 5000);
                    }
                    else {
                ...
                var fileToUpload = this.files;
                var fileIdx = __WEBPACK_IMPORTED_MODULE_5_lodash__["range"](fileToUpload.length);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(46), __webpack_require__(569)(module)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var webcam_component_1 = __webpack_require__(562);
exports.WebCamComponent = webcam_component_1.WebCamComponent;
var webcam_module_1 = __webpack_require__(571);
...
var core_1 = __webpack_require__(0);
var webcam_component_1 = __webpack_require__(562);
var AckMediaDevices_directive_1 = __webpack_require__(572);
var declarations = [
